return {
  ...
  opts = {
    ...
    spec = {
      ...
      { "<leader>ln",       ":lua vim.diagnostic.jump({ count = 1 })<CR>",                       desc = "Next diagnostic",                   nowait = true,       remap = false },
      { "<leader>lp",       ":lua vim.diagnostic.jump({ count = -1 })<CR>",                      desc = "Previous diagnostic",               nowait = true,       remap = false },
