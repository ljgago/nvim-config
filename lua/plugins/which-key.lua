return {
  ...
  opts = {
    ...
    spec = {
      ...
      { "<leader>y",        '"+y',                                                               mode = { "n", "x" },                       desc = "Copy to system clipboard",    nowait = true, remap = false, silent = true },
      { "<leader>p",        '"+p',                                                               mode = { "n", "v" },                       desc = "Paste from system clipboard", nowait = true, remap = false },
      -- { "<leader>p",        '"+P',                                                               mode = { "n", "v", "x" },                  desc = "Paste from system clipboard", nowait = true, remap = false },
